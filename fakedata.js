...
export const categories = [
    ...
    {
        name: "Beautify",
        image: "https://m.media-amazon.com/images/I/51c0KsMQLYL._SR270,360_.png"
    },
    {
        name: "Electronics",
        image: "https://m.media-amazon.com/images/I/51BwEB9glsL._SR270,360_.png"
    },
    {
        name: "Fashion",
        image: "https://m.media-amazon.com/images/I/413tmL4Y0kL._SR270,360_.jpg"
    }
]

export const products = () => (
    productsData.slice().reduce((shuffled, item, index) => {
        shuffled.splice(Math.floor(Math.random() * productsData.length), 0, item)
        return shuffled
    }, [])
)
